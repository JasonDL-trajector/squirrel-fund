...
export default function DepositPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const newBalanceAmount = balance !== null ? balance + depositAmount : depositAmount;

    try {
      await createDeposit({ name, depositAmount, depositNote, depositDate });
      await createBalance({ balanceAmount: newBalanceAmount, balanceDate: depositDate });
      router.push('/home');
    } catch (err) {
        ...
        <form onSubmit={handleSubmit}>
          <Card className="max-w-md mx-auto">
            <CardHeader>
              ...
              <CardDescription>Fill out the form below to submit a deposit to your squirrel fund.</CardDescription>
            </CardHeader>
